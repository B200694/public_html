...
def fetch_seqs(taxon, protein_family) :
    ...
    records = Entrez.efetch(db="protein", id=",".join(id_list), rettype="fasta", retmode="text") # create new handle storing sequence information
    ...
    for record in SeqIO.parse(records, "fasta"):
        ...
        organism = record.description.split
